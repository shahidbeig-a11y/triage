...
export default function WorkPage() {
  ...
  async function loadEmails() {
    try {
      ...
      // Filter to only Work emails (categories 1-6)
      ...
      console.log("Normalized emails:", normalizedEmails.length, "Work emails:", workEmails.length);
  ...
  async function loadCategories() {
    try {
      ...
      const workCats = await fetchCategories("All Mail / Work");
      ...
      <div className="rounded-lg border border-[#16163a] bg-[#13132d] p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-semibold text-[#E0E0EE]">Work</h1>
